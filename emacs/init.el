...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (protobuf-mode graphql-mode yaml-mode web-mode vue-mode virtualenvwrapper use-package toml-mode tide thrift swift-mode spotify solarized-theme smartparens seeing-is-believing ruby-test-mode rinari rg restclient rainbow-mode rainbow-delimiters racket-mode racer prettier-js play-routes-mode origami org-present org-bullets nose neotree mocha markdown-toc magit lsp-vue lsp-ui jsx-mode json-mode jade-mode helm-rg helm-projectile helm-circe helm-ag haskell-mode haml-mode gruvbox-theme groovy-mode gist flycheck-swift flycheck-rust exec-path-from-shell evil-surround evil-leader ensime emmet-mode dockerfile-mode company-sourcekit company-rtags company-lsp company-irony company-go coffee-mode cmake-mode clj-refactor chruby cargo auto-complete alchemist ag ace-window ace-jump-mode)))
